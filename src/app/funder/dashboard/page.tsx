    ...
    <FunderShell orgName={funder.org_name}>
      <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 sm:mb-8">
          <div>
            <h1 className="font-display font-bold text-[#0D1117] text-xl sm:text-2xl">
          ...
          <Link
            ...
            className="flex items-center gap-2 bg-[#0F2B4C] text-white font-semibold text-sm px-4 sm:px-5 py-2.5 rounded-xl hover:bg-[#0a1f38] transition-colors self-start sm:self-auto flex-shrink-0"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          {[
            ...
            <div key={stat.label} className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 shadow-sm">
              <div className="text-xl sm:text-2xl mb-2">{stat.icon}</div>
              <div className={`text-xl sm:text-3xl font-bold font-display ${stat.color}`}>{stat.value}</div>
